...
{
    if(value == 1) {blue = true; red = false; green = false;}
    if(value == 2) {blue = false; red = true; green = false;}
    if(value == 3) {blue = false; red = false; green = true;}
}
